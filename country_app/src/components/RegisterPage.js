...
const RegisterPage = () => {
    ...
    return (
        <div className="flex items-center justify-center h-[80vh] sm:h-screen bg-gray-100 px-4 py-6 sm:py-0">
            <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg">
                <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-6">Register</h2>
